...
import { sampleSellerProducts } from "./sampleData";
...
const SellerProfile = () => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                if (token && user?._id) {
                    ...
                    setProducts(sampleSellerProducts);
                }
            } catch (error) {
                setProducts(sampleSellerProducts);
            }
    ...
    const onSelectImage = (e) => {
        ...
        reader.onload = () => {
            ...
            setNewProduct({ ...newProduct, imageFile: file, imageUrl: base64 });
        };
    ...
    const removeProduct = async (product) => {
        try {
            ...
            if (token && (product._id || product.id)) {
                await api.products.delete(product._id || product.id, token);
            }
        } catch (e) {
